...
async def get_account_stats(session: aiohttp.ClientSession, username: str) -> dict:
    ...
    # Instagram frequently returns HTTP 200 for banned/deactivated/removed
    # profiles too, but serves a generic "not available" page instead of a
    # real 404. Treat that content as banned as well.
